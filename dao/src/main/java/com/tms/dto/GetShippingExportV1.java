...
public class GetShippingExportV1 {
    ...
    public Integer getPaidCod() {
        return paidCod;
    }

    public void setPaidCod(Integer paidCod) {
        this.paidCod = paidCod;
    }

    public String getPaidCodDate() {
        return paidCodDate;
    }

    public void setPaidCodDate(String paidCodDate) {
        this.paidCodDate = paidCodDate;
    }

    public String getSecondDeliveryTime() {
        return secondDeliveryTime;
    }

    public void setSecondDeliveryTime(String secondDeliveryTime) {
        this.secondDeliveryTime = secondDeliveryTime;
    }

    public String getThirdDeliveryTime() {
        return thirdDeliveryTime;
    }

    public void setThirdDeliveryTime(String thirdDeliveryTime) {
